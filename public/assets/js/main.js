...
(function ($) {
  ...
  function mainSlider() {
    ...
    BasicSlider.on("init", function (e, slick) {
      var $firstAnimatingElements = $(".tp-single-slider:first-child").find(
        "[data-animation]"
      );
    ...
    BasicSlider.on(
      ...
      function (e, slick, currentSlide, nextSlide) {
        var $animatingElements = $(
          '.tp-single-slider[data-slick-index="' + nextSlide + '"]'
        ).find("[data-animation]");
    ...
    BasicSlider.slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" className="slick-prev"></i><span>Next</span> </button>',
      nextArrow:
        '<button type="button" className="slick-next"><span>Prev</span></i> </button>',
      responsive: [
        {
          breakpoint: 992,
          settings: {
  ...
  $(".tp-silder-acive-2").slick({
    ...
    arrows: true,
    prevArrow:
      '<button type="button" className="slick-prev"><span><i className="fal fa-angle-left"></i></span></button>',
    nextArrow:
      '<button type="button" className="slick-next"><span><i className="fal fa-angle-right"></i></span></button>',
    responsive: [
      {
        breakpoint: 600,
        settings: {
  ...
  $(".tp-testimonial-active").slick({
    ...
    prevArrow:
      '<button type="button" className="slick-prev"><span><i className="fal fa-angle-left"></i></span></button>',
    nextArrow:
      '<button type="button" className="slick-next"><i className="fal fa-angle-right"></button>',
    responsive: [
      {
        breakpoint: 992,
        settings: {
